...
public class SwingListenerDemo_MouseListener {
    private JFrame mainFrame;
    private JLabel headerLabel;
    private JLabel statusLabel;
    private JPanel controlPanel;

    public SwingListenerDemo_MouseListener() {
        prepareGUI();
    }

    public static void main(String[] args) {
        SwingListenerDemo_MouseListener swingListenerDemo = new SwingListenerDemo_MouseListener();
